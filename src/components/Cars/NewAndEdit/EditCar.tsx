...
const EditCar = ({carDetail}: Props) => {
  ...
  const handleChangeGas = (event: SelectChangeEvent) => {
      ...
      <Box sx={{ width: "90%" }}>
        ...
        <FormControl fullWidth sx={{ m: 1, width: "35ch" }}>
            <TextField
              ...
              variant="filled"
              defaultValue={carDetail?.carRegistrationPlate}
              onChange={handleChangeEvent}
            />
          </FormControl>
        <Box sx={{ display: "flex", justifyContent: "center" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
          <TextField
            ...
            name="mileage"
            sx={{ m: 1, width: "25ch" }}
            defaultValue={carDetail?.mileage}        
            onChange={handleChangeEvent}
            InputProps={{
              startAdornment: (
